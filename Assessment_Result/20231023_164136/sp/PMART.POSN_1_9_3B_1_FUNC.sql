REPLACE PROCEDURE PMART.POSN_1_9_3B_1_FUNC
(
FP_TIME_TYPE  CHAR,         
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE ('#VT_POSN_1_9_3B_1_FUNC'); 
   ...
   SET V_SQL =
     ...
     SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_POSN_1_9_3B_1_FUNC  AS('+
          'SELECT '+
          'A.TIME_ID, '+ 
          'A.PRD_ID, '+  
          V_SQL +
          ...
          ' AND A.TIME_ID=C.TIME_ID AND A.ORG_ID=C.ORG_ID AND A.MMA_ID=C.MMA_ID GROUP BY A.TIME_ID,A.PRD_ID'+
