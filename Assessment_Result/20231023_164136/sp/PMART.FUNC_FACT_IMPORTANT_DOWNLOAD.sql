REPLACE PROCEDURE PMART.FUNC_FACT_IMPORTANT_DOWNLOAD
(
...
SP:BEGIN
   ...
   END IF;
	IF P_PRDTYPE = '-1' THEN
        ...
        SET PRDWHERE = ' JOIN PDATA.FESTL_PRD_SET T4 ON T4.ACT_ID = ' + P_ACTID + ' AND T1.PRD_ID = CAST(T4.FM_CODE AS VARCHAR(7)) ';
		SET PRDANDWHERE = '';
