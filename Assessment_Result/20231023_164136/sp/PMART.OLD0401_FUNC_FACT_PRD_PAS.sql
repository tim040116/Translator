REPLACE PROCEDURE PMART.OLD0401_FUNC_FACT_PRD_PAS
(
...
SP:BEGIN
    ...
    CALL PMART.P_DROP_TABLE ('#VT_FUNC_FACT_PRD_PAS');
    SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_FUNC_FACT_PRD_PAS ( '
    ...
    SET SQLSTR = 'INSERT INTO #VT_FUNC_FACT_PRD_PAS(PARENT_PRD_ID,PRD_ID,FM_NAME,ALLOW_DRILL_DOWN,PRD_LEVEL,DRILL_PRD_LEVEL,DRILL_PRD_ID) '
	                     +'SELECT * FROM( ';
