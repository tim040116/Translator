REPLACE PROCEDURE PMART.REMD_OCAL_STYPE_FUNC(P_DAY_ID NUMBER,P_STYPE_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(10000) DEFAULT ''; 
  CALL PMART.P_DROP_TABLE ('#VT_REMD_OCAL_STYPE_FUNC'); 
  CALL PMART.REMD_OT_STYPE_FUNC(P_DAY_ID,P_STYPE_ID);
      SET SQLSTR = 
          'CREATE MULTISET VOLATILE TABLE #VT_REMD_OCAL_STYPE_FUNC AS('+            
               'SELECT '+
               'TOT_ID, '+
               'OSTORE_ID, '+
