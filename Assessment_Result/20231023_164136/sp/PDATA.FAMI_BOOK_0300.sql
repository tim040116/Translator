REPLACE  PROCEDURE PDATA.FAMI_BOOK_0300
(
)
SP:BEGIN
CALL PDATA.P_DROP_TABLE('PTEMP.TP1_FACT_MMK_BOOK');
CREATE TABLE PTEMP.TP1_FACT_MMK_BOOK AS PMART.FACT_MMK_ENT WITH NO DATA;
CALL PDATA.P_DROP_TABLE('PTEMP.TP2_FACT_MMK_BOOK');
CREATE TABLE PTEMP.TP2_FACT_MMK_BOOK AS PMART.FACT_MMK_ENT WITH NO DATA;
CALL PDATA.P_DROP_TABLE('PTEMP.TP3_FACT_MMK_BOOK');
CREATE TABLE PTEMP.TP3_FACT_MMK_BOOK AS PMART.FACT_MMK_ENT WITH NO DATA;
INSERT INTO PTEMP.TP1_FACT_MMK_BOOK
SELECT OSTORE_ID,
...
INSERT INTO PTEMP.TP2_FACT_MMK_BOOK
SELECT COALESCE(T2.OSTORE_ID,COALESCE(T2.BRANCH_ID,COALESCE(T2.DEPT_ID,COALESCE(T2.PDEPT_ID,-1)))) AS ORG_ID,
 ...
 FROM PTEMP.TP1_FACT_MMK_BOOK T1
...
DELETE FROM PMART.FACT_MMK_ENT WHERE TRAN_CNT = 0;
DROP TABLE PTEMP.TP0_FAMI_BOOK;
DROP TABLE PTEMP.TP1_FACT_MMK_BOOK;
DROP TABLE PTEMP.TP2_FACT_MMK_BOOK;
DROP TABLE PTEMP.TP3_FACT_MMK_BOOK;
END SP;