REPLACE PROCEDURE PMART.NEW_TMX_MMA_MODULE
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TMX_MMA_MODULE'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TMX_MMA_MODULE  AS('+
                   'SELECT '+
