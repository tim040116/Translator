REPLACE PROCEDURE PMART.NEW_TPO_AVG_MODULE_STNUM_2
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TPO_AVG_MODULE_STNUM_2'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TPO_AVG_MODULE_STNUM_2  AS('+
                 'SELECT '+
                 ...
                 'DECODE((DECODE(A.ORDER_AMT,0,NULL,A.ORDER_AMT) /  DECODE(B.STNUM_STORE_NUM,0,NULL,B.STNUM_STORE_NUM)),0,NULL,(DECODE(A.ORDER_AMT,0,NULL,A.ORDER_AMT) /  DECODE(B.STNUM_STORE_NUM,0,NULL,B.STNUM_STORE_NUM)))*100 AS THROW_AMT_RATE,  '+
                 ...
                 'DECODE((DECODE(A.ORDER_CNT,0,NULL,A.ORDER_CNT)/ DECODE(B.STNUM_STORE_NUM,0,NULL,B.STNUM_STORE_NUM)),0,NULL, (DECODE(A.ORDER_CNT,0,NULL,A.ORDER_CNT)/ DECODE(B.STNUM_STORE_NUM,0,NULL,B.STNUM_STORE_NUM)))*100 AS THROW_CNT_RATE, '+
