REPLACE PROCEDURE PMART.NEW_TOP_MMA_MODULE
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TOP_MMA_MODULE'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOP_MMA_MODULE  AS( '+
                     'SELECT '+
                        'A.MMA_ID AS MMA_ID, '+
                        'A.ORG_ID AS ORG_ID, '+
