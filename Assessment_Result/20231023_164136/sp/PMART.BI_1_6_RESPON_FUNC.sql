REPLACE PROCEDURE PMART.BI_1_6_RESPON_FUNC
(
	P_WEEK_ID NUMBER,
	P_BRANCH_ID NUMBER
)
...
SP:BEGIN
	...
	CALL PMART.P_DROP_TABLE ('#VT_BI_1_6_RESPON_FUNC');
	CALL PMART.BI_1_6_RESPON_S_FUNC(P_WEEK_ID, P_BRANCH_ID);
	SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_BI_1_6_RESPON_FUNC  AS( ' 
				+ ' SELECT * FROM #VT_BI_1_6_RESPON_S_FUNC '
				+ ' UNION '
