REPLACE PROCEDURE PMART.FILLBLANK_NCIG (IN P_MONTH_ID NUMBER)
...
SP:BEGIN
  ...
  CALL PMART.P_DROP_TABLE ('#VT_FILLBLANK_NCIG');
  SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_FILLBLANK_NCIG  
    (    
       OSTORE_ID NUMBER
      ,OPNDT NUMBER
      ,ENDDT NUMBER
  ...
  DO    
     L1_1:
        BEGIN 
         ...
         INSERT INTO  #VT_FILLBLANK_NCIG  (OSTORE_ID,OPNDT,ENDDT ) VALUES (P_OSTORE_ID,P_OPNDT,P_ENDDT);   
         INSERT INTO PMART.REMD_FACT_NCIG  (L_DAY_ID,OSTORE_ID,STORE_ID
         ,BUDGET_ST_AVG_AMT,BUDGET_ST_TOT_AMT
         ,BUDGET_DEPT_AVG_AMT ,BUDGET_DEPT_TOT_AMT
         ,STATUS,AC
         ,BUDGET_PDEPT_AVG_AMT,BUDGET_PDEPT_TOT_AMT
         )
         SELECT 
          S.L_DAY_ID
         ,S.OSTORE_ID
         ...
         LEFT OUTER JOIN 
          ...
          ON 1 = 1  
         ) S LEFT OUTER  JOIN PMART.REMD_FACT_NCIG  T
