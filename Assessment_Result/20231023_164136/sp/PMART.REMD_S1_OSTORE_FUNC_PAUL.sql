REPLACE PROCEDURE PMART.REMD_S1_OSTORE_FUNC_PAUL
(P_DAY_ID NUMBER,P_RESPON_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(8000) DEFAULT ''; 
  CALL PMART.P_DROP_TABLE ('#VT_REMD_S1_OSTORE_FUNC_PAUL'); 
  LOCKING PMART.REMD_FACT FOR ACCESS;
  LOCKING PMART.LAST_ORG_DIM FOR ACCESS;
      SET SQLSTR = 
          'CREATE MULTISET VOLATILE TABLE #VT_REMD_S1_OSTORE_FUNC_PAUL AS('+            
		   'SELECT '+
