REPLACE PROCEDURE PMART.NEW_TPO_STFACT
...
DECLARE V_TABLE_NAME VARCHAR(30);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TPO_STFACT'); 
   CASE
      ...
      WHEN FP_TIME_TYPE='D' AND FP_PRD_TYPE='R' AND FP_PRD_LEVEL=1  THEN  
            SET V_TABLE_NAME = 'BASIC_STFACT_DETAIL';
      WHEN FP_PRD_TYPE='L' THEN 
            SET V_TABLE_NAME = 'PMART.BASIC_STLFACT';
      ELSE  
            SET V_TABLE_NAME = 'PMART.BASIC_STFACT';
    END CASE;
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TPO_STFACT AS('+
