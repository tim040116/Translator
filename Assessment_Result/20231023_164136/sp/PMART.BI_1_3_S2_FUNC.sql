REPLACE PROCEDURE PMART.BI_1_3_S2_FUNC(P_TIME_ID NUMBER,P_LEVEL NUMBER,P_ORG_ID NUMBER,P_PRD_ID VARCHAR(7),P_PRD_VALUE NUMBER)
...
SP:BEGIN
  ...
  DO    
     ...
     END L1_1;     
  END WHILE L1;
      CALL PMART.P_DROP_TABLE ('#VT_BI_1_3_S2_FUNC');  
      SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_BI_1_3_S2_FUNC  AS('+
