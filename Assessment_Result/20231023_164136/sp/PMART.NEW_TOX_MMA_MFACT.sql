REPLACE PROCEDURE PMART.NEW_TOX_MMA_MFACT
(FP_AMT_TYPE CHAR(1),
...
CALL PMART.P_DROP_TABLE ('#VT_NEW_TOX_MMA_MFACT'); 
CASE
...
END CASE;   
     IF FP_AMT_TYPE='T' THEN
      ...
      END IF;
SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOX_MMA_MFACT  AS('+   
'SELECT '+
'F1.MMA_ID AS MMA_ID, '+
'F1.ORG_ID AS ORG_ID, '+
