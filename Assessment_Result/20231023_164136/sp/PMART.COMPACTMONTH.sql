REPLACE PROCEDURE PMART.COMPACTMONTH (P_MONTH_ID NUMBER)
...
,SUM(A.SCUST_NUM)      OVER (PARTITION BY A.OSTORE_ID )                                                AS TOT_SCUST_NUM
,SUM(A.SCUST_NUM)      OVER (PARTITION BY A.OSTORE_ID ORDER BY A.L_DAY_ID ROWS UNBOUNDED PRECEDING )   AS ACCU_SCUST_NUM
...
,TOT_SCUST_NUM  =S.TOT_SCUST_NUM
,ACCU_SCUST_NUM =S.ACCU_SCUST_NUM
