REPLACE PROCEDURE PMART.NEW_TPX_MMA_MFACT_SUM
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TPX_MMA_MFACT'); 
   CALL PMART.NEW_TPX_MMA_MFACT(FP_AMT_TYPE,FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_LIST,FP_ORG_LEVEL,FP_ORG_ID,FP_MMA_LIST);
    ...
    SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TPX_MMA_MFACT_SUM  AS('+    
		    'SELECT '+
			'TIME_ID AS TIME_ID, '+
			'PRD_ID AS PRD_ID, '+
			'-2 AS MMA_ID, '+
