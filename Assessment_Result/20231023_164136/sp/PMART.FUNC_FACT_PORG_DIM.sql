REPLACE PROCEDURE PMART.FUNC_FACT_PORG_DIM
(
...
SP:BEGIN
    ...
    CALL PMART.P_DROP_TABLE ('#VT_FUNC_FACT_PORG_DIM');
    SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_FUNC_FACT_PORG_DIM ( '
    ...
    SET SQLSTR = 'INSERT INTO #VT_FUNC_FACT_PORG_DIM(PARENT_ORG_ID,ORG_ID,ORG_VAL,ORG_SNAME,ORG_NO,ALLOW_DRILL_DOWN,ORG_LEVEL,DRILL_ORG_LEVEL,DRILL_ORG_ID) '
	                     +'SELECT * FROM( ';
