REPLACE PROCEDURE PMART.POSI1_5_RPT3_FUNC(P_L_DAY_ID VARCHAR(400),P_RPT VARCHAR(400),P_UNIT VARCHAR(400))
...
SP:BEGIN
   ...
   IF (P_RPT='RPT3_1' AND P_UNIT='GRP' ) THEN
      SET SQLSTR ='INSERT INTO #VT_POSI1_5_RPT3_FUNC(TIME_ID,PRD_ID,SALES_AMT_PSD,BUDGET_AMT_PSD,PSD_RATE) '+
           ' SELECT T.TIME_ID, '+           
           ' CAST(CAST(T.PRD_ID AS VARCHAR(10))+''.''+CAST(A.RESPON_ID AS VARCHAR(10)) AS DECIMAL(22,10)) , '+ 
   ...
   IF (P_RPT='RPT3_1' AND P_UNIT='KND' ) THEN
      SET SQLSTR ='INSERT INTO #VT_POSI1_5_RPT3_FUNC(TIME_ID,PRD_ID,SALES_AMT_PSD,BUDGET_AMT_PSD,PSD_RATE) '+           
           ' SELECT T.TIME_ID, '+           
           ' CAST(CAST(A.KND_ID AS VARCHAR(10))+''.''+CAST(A.RESPON_ID AS VARCHAR(10)) AS DECIMAL(22,10)) , '+ 
