REPLACE PROCEDURE PMART.NEW_MTX_MMA_AVG_MODULE
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_MTX_MMA_AVG_MODULE'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_MTX_MMA_AVG_MODULE  AS('+
                    'SELECT '+
                    'A.MMA_ID AS MMA_ID, '+
