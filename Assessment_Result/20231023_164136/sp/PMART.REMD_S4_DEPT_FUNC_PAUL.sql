REPLACE PROCEDURE PMART.REMD_S4_DEPT_FUNC_PAUL(P_DAY_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(4000) DEFAULT ''; 
  CALL PMART.P_DROP_TABLE ('#VT_REMD_S4_DEPT_FUNC_PAUL'); 
  LOCKING PMART.BASIC_OST_FACT FOR ACCESS;
  LOCKING PMART.LAST_ORG_DIM_MASK FOR ACCESS;
      SET SQLSTR = 
          'CREATE MULTISET VOLATILE TABLE #VT_REMD_S4_DEPT_FUNC_PAUL AS('+            
				        'SELECT '+
                'B.ORG_ID AS ORG_ID, '+
