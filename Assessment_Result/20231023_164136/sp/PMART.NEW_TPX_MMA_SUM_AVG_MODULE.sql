REPLACE PROCEDURE PMART.NEW_TPX_MMA_SUM_AVG_MODULE
...
SP:BEGIN
   DECLARE SQLSTR  VARCHAR(64000); 	
    CALL PMART.P_DROP_TABLE ('#VT_NEW_TPX_MMA_MFACT_SUM'); 
	CALL PMART.NEW_TPX_MMA_MFACT_SUM(FP_AMT_TYPE,FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_LIST,FP_ORG_LEVEL,FP_ORG_ID,FP_MMA_LIST);
    ...
    CALL PMART.P_DROP_TABLE ('#VT_NEW_TPX_MMA_SUM_AVG_MODULE'); 
    SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TPX_MMA_SUM_AVG_MODULE  AS('+    
						'SELECT '+
