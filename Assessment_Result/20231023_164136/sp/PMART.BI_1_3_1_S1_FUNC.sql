REPLACE PROCEDURE PMART.BI_1_3_1_S1_FUNC(P_TIME_ID NUMBER,P_LEVEL NUMBER,P_ORG_ID NUMBER,P_PRD_ID VARCHAR(7),P_PRD_VALUE NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
   DECLARE SQLSTR VARCHAR(1000);
   DECLARE ORG_STR VARCHAR(400);
   DECLARE TAB_STR VARCHAR(100);
   CALL PMART.P_DROP_TABLE ('#VT_BI_1_3_1_S1_FUNC');          
   IF (P_LEVEL=-1) THEN  
   ...
   END IF;
   SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_BI_1_3_1_S1_FUNC  AS('+
