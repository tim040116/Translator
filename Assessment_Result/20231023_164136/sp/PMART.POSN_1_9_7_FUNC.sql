REPLACE PROCEDURE PMART.POSN_1_9_7_FUNC
(							 
P_TIME_TYPE VARCHAR(400), 
P_TIME_LIST VARCHAR(400), 
P_MMA_TYPE  NUMBER, 
P_MMA_LIST  VARCHAR(400), 
P_ORG_LEVEL NUMBER, 
P_ORG_LIST VARCHAR(400), 
P_PRD_TYPE VARCHAR(400), 
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE('#VT_POSN_1_9_7_FUNC');
   CALL PMART.POSN_MFACT_FUNC(P_TIME_TYPE,P_TIME_LIST,P_PRD_LEVEL,P_PRD_ID,1,P_ORG_LEVEL,P_ORG_LIST,P_MMA_TYPE,P_MMA_LIST,P_PRD_TYPE,P_AMT_TYPE);
   CALL PMART.POSN_STFACT_FUNC(P_TIME_TYPE,P_TIME_LIST,P_PRD_LEVEL,P_PRD_ID,1,P_ORG_LEVEL,P_ORG_LIST,P_MMA_TYPE,P_MMA_LIST,P_PRD_TYPE);
   CALL PMART.POSN_SFACT_FUNC(P_TIME_TYPE,P_TIME_LIST,P_ORG_LEVEL,P_ORG_LIST,P_MMA_TYPE,P_MMA_LIST);
   SET V_SQL = 
   ...
   SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_POSN_1_9_7_FUNC  AS('+
        'SELECT '+
          'A.MMA_ID AS MMA_ID, '+
          'A.ORG_ID AS ORG_ID, '+
          V_SQL +
          ...
          ' AND A.TIME_ID=C.TIME_ID AND A.ORG_ID=C.ORG_ID AND A.MMA_ID=C.MMA_ID GROUP BY A.MMA_ID,A.ORG_ID'+
