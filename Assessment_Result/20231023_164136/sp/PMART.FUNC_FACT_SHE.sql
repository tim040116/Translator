REPLACE PROCEDURE PMART.FUNC_FACT_SHE
(
...
SP:BEGIN
   ...
   SET ORGWHERE = ' WHERE 1=1 ';
	...
	END IF;
CALL PMART.P_DROP_TABLE ('#VT_FACT_SHE');
SET SQLSTR = ' CREATE MULTISET VOLATILE TABLE #VT_FACT_SHE AS('
						 + ' SELECT ' + P_GROUP + ', '
