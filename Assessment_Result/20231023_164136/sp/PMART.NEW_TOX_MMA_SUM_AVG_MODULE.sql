REPLACE PROCEDURE PMART.NEW_TOX_MMA_SUM_AVG_MODULE
...
CALL PMART.P_DROP_TABLE ('#VT_NEW_TOX_MMA_SUM_AVG_MODULE'); 
CALL PMART.NEW_TOX_MMA_MFACT_SUM(FP_AMT_TYPE,FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_ORG_LEVEL,FP_ORG_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_ID,FP_MMA_LIST);
