REPLACE PROCEDURE PMART.NEW_TOX_MMA_SUM_MODULE
...
CALL PMART.P_DROP_TABLE ('#VT_NEW_TOX_MMA_SUM_MODULE'); 
CALL PMART.NEW_TOX_MMA_MODULE(FP_AMT_TYPE,FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_ORG_LEVEL,FP_ORG_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_ID,FP_MMA_LIST);
SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOX_MMA_SUM_MODULE  AS('+
						'SELECT '+
						  'TIME_ID AS TIME_ID , '+
						  'ORG_ID  AS ORG_ID, '+
						  '-2 AS MMA_ID , '+
						  ...
						  'SUM(ITMTRANSFER_EXTEND_PRE_NUM) ITMTRANSFER_EXTEND_PRE_NUM '+
						'FROM #VT_NEW_TOX_MMA_MODULE '+
