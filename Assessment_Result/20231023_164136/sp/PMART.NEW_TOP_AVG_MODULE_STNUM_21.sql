REPLACE PROCEDURE PMART.NEW_TOP_AVG_MODULE_STNUM_21
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TOP_AVG_MODULE_STNUM_21'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOP_AVG_MODULE_STNUM_21  AS('+
                'SELECT '+
