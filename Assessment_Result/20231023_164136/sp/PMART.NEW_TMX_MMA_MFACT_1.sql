REPLACE PROCEDURE PMART.NEW_TMX_MMA_MFACT_1
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TMX_MMA_MFACT_1'); 
   CASE
      ...
      ELSE
             SET V_TABLE_NAME = 'PMART.BASIC_MFACT_SHOP';
   END CASE;
   SET SQLSTR1 = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TMX_MMA_MFACT_1  AS('+
     'SELECT '+
