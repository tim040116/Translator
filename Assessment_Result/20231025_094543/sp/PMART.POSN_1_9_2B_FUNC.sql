REPLACE PROCEDURE PMART.POSN_1_9_2B_FUNC
(
FP_TIME_TYPE CHAR,         
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE ('#VT_POSN_1_9_2B_FUNC'); 
   CALL PMART.POSN_MFACT_1_9(FP_TIME_TYPE,FP_TIME_LIST,FP_PRD_LEVEL,FP_PRD_ID,1,FP_ORG_LEVEL,FP_ORG_LIST,FP_MMA_TYPE,FP_MMA_RANGE,FP_MMA_LIST,FP_PRD_TYPE,FP_AMT_TYPE);
   CALL PMART.POSN_STFACT_1_9(FP_TIME_TYPE,FP_TIME_LIST,FP_PRD_LEVEL,FP_PRD_ID,1,FP_ORG_LEVEL,FP_ORG_LIST,FP_MMA_TYPE,FP_MMA_RANGE,FP_MMA_LIST,FP_PRD_TYPE);
   CALL PMART.POSN_SFACT_1_9(FP_TIME_TYPE,FP_TIME_LIST,FP_ORG_LEVEL,FP_ORG_LIST,FP_MMA_TYPE,FP_MMA_RANGE,FP_MMA_LIST);
   SET V_SQL =
     ...
     SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_POSN_1_9_2B_FUNC  AS('+
          'SELECT '+
          'A.PRD_ID, '+ 
          'A.ORG_ID, '+ 
          V_SQL +
          ' FROM #VT_POSN_MFACT_1_9 A '+
          ' ,#VT_POSN_STFACT_1_9 B '+
          ' ,#VT_POSN_SFACT_1_9 C  '+
