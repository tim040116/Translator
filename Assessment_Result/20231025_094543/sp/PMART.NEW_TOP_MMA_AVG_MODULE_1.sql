REPLACE PROCEDURE PMART.NEW_TOP_MMA_AVG_MODULE_1
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TOP_MMA_AVG_MODULE_1'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOP_MMA_AVG_MODULE_1  AS('+
                    'SELECT '+
		    'A.MMA_ID AS MMA_ID, '+
		    'A.ORG_ID AS ORG_ID, '+
