REPLACE PROCEDURE PMART.OLD0401_FUNC_FACT_IMPORTANT_DOWNLOAD
(
...
SP:BEGIN
   ...
   END IF;   
CALL PMART.P_DROP_TABLE ('#VT_FACT_IMPORTANT_DOWNLOAD');
SET SQLSTR = ' CREATE MULTISET VOLATILE TABLE #VT_FACT_IMPORTANT_DOWNLOAD AS('						 
						   ...
						   + ' 	    JOIN ( '
						   + ' 	 		SELECT A.DEPT_NO, B.BRANCH_NO, C.STORE_NO, C.STORE_NAME, C.OSTORE_ID,P.PDEPT_NO '
