REPLACE PROCEDURE PMART.REMD_T1_NCIG_OSTORE_FUNC
(P_DAY_ID NUMBER,P_RESPON_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(8000) DEFAULT ''; 
  CALL PMART.P_DROP_TABLE ('#VT_REMD_T1_NCIG_OSTORE_FUNC'); 
      SET SQLSTR = 
          'CREATE MULTISET VOLATILE TABLE #VT_REMD_T1_NCIG_OSTORE_FUNC AS('+            
		   'SELECT '+
