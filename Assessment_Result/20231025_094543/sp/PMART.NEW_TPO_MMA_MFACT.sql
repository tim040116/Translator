REPLACE PROCEDURE PMART.NEW_TPO_MMA_MFACT
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TPO_MMA_MFACT'); 
   CASE
      ...
      ELSE
             SET V_TABLE_NAME = 'PMART.BASIC_MFACT_SHOP';
   END CASE;
   SET SQLSTR1 = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TPO_MMA_MFACT  AS('+
     'SELECT '+
         'F1.MMA_ID AS MMA_ID, '+
         'F1.PRD_ID AS PRD_ID, '+
