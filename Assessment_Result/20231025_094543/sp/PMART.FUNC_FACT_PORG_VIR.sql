REPLACE PROCEDURE PMART.FUNC_FACT_PORG_VIR
(
...
SP:BEGIN
    ...
    CALL PMART.P_DROP_TABLE ('#VT_FUNC_FACT_PORG_VIR');
    SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_FUNC_FACT_PORG_VIR ( '
    ...
    SET SQLSTR = 'INSERT INTO #VT_FUNC_FACT_PORG_VIR(PARENT_ORG_ID,ORG_ID,ORG_VAL,ORG_SNAME,ORG_NO,ALLOW_DRILL_DOWN,ORG_LEVEL,DRILL_ORG_LEVEL,DRILL_ORG_ID) '
	                     +'SELECT * FROM( ';
