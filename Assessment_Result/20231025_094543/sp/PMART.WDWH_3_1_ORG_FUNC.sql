REPLACE PROCEDURE PMART.WDWH_3_1_ORG_FUNC
(
...
SP:BEGIN
  ...
  CALL PMART.P_DROP_TABLE ('#VT_WDWH_3_1_ORG_FUNC');
  IF (I_ORG_TYPE = '-1') THEN
      SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_WDWH_3_1_ORG_FUNC AS  ' +
                  '(SELECT * FROM (                                         ' +
