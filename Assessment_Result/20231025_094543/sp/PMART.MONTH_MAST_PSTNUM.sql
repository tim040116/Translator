REPLACE PROCEDURE PMART.MONTH_MAST_PSTNUM
(P_DAY_ID NUMBER,P_ORG_ID NUMBER,P_LEVEL NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(4000) DEFAULT ''; 
  CALL PMART.P_DROP_TABLE ('#VT_MONTH_MAST_PSTNUM'); 
    CASE P_LEVEL
      WHEN -1 THEN   
         SET SQLSTR = 
            'CREATE MULTISET VOLATILE TABLE #VT_MONTH_MAST_PSTNUM AS('+            
