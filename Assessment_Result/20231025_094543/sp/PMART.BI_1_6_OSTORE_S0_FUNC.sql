REPLACE PROCEDURE PMART.BI_1_6_OSTORE_S0_FUNC
(
	P_TIME_ID NUMBER
)
...
SP:BEGIN
   DECLARE SQLSTR VARCHAR(1000) DEFAULT '';
      CALL PMART.P_DROP_TABLE ('#VT_BI_1_6_OSTORE_S0_FUNC');  
      SET SQLSTR = ' CREATE MULTISET VOLATILE TABLE #VT_BI_1_6_OSTORE_S0_FUNC  AS('
					+ ' SELECT A.OSTORE_ID AS ORG_ID, SUM(UPLOAD_STNUM) AS STNUM '
