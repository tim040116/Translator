REPLACE PROCEDURE PMART.NEW_TMX_MMA_MODULE_1
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TMX_MMA_MODULE_1'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TMX_MMA_MODULE_1  AS('+
                   'SELECT '+
