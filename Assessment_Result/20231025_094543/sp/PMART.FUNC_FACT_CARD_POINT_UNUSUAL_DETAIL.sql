REPLACE PROCEDURE PMART.FUNC_FACT_CARD_POINT_UNUSUAL_DETAIL
(
   IN P_TIME INTEGER,
...
SP:BEGIN
	 ...
	 IF P_CARD_TYPE = 10  THEN 
         ...
         SET SQLSTR = ' CREATE MULTISET VOLATILE TABLE #VT_FACT_CARD_POINT_UNUSUAL_DETAIL AS( '	
                          ...
                          +'                 ,P.BASE_POINT  '
                          +'                 ,P.EX_POINT  '
                          +'   FROM (       SELECT TX_SEQ,OSTORE_ID, '+BASE_POINT+' AS BASE_POINT,SUM(DWH_FG*TXN_POINT) AS EX_POINT '
	 ...
	 ELSEIF P_CARD_TYPE = 6  THEN
         ...
         SET SQLSTR = ' CREATE MULTISET VOLATILE TABLE #VT_FACT_CARD_POINT_UNUSUAL_DETAIL AS( '	
                          ...
                          +'                 ,P.BASE_POINT  '
                          +'                 ,P.EX_POINT  '
                          +'   FROM (       SELECT TX_SEQ,OSTORE_ID, '+BASE_POINT+ ' AS BASE_POINT,SUM('+TRIM(QUERYCOLUMN) +')  AS EX_POINT '
