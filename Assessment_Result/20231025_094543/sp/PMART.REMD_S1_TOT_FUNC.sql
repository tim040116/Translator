REPLACE PROCEDURE PMART.REMD_S1_TOT_FUNC(P_DAY_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(4000) DEFAULT ''; 
  CALL PMART.P_DROP_TABLE ('#VT_REMD_S1_TOT_FUNC'); 
  LOCKING PMART.REMD_FACT_SUM FOR ACCESS;   
      SET SQLSTR = 
          'CREATE MULTISET VOLATILE TABLE #VT_REMD_S1_TOT_FUNC AS('+
          'SELECT '+
          '-1 AS ORG_ID, '+
          'A.AMT AS AMT, '+
