REPLACE PROCEDURE PMART.NEW_TMX_MMA_STFACT
...
DECLARE V_TABLE_NAME VARCHAR(60);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TMX_MMA_STFACT'); 
   CASE
    ...
    END CASE;
    SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TMX_MMA_STFACT  AS('+
