REPLACE PROCEDURE PMART.NEW_TOP_MMA_MODULE_1
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TOP_MMA_MODULE_1'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOP_MMA_MODULE_1  AS( '+
                     'SELECT '+
                        'A.MMA_ID AS MMA_ID, '+
                        'A.ORG_ID AS ORG_ID, '+
                        ...
                        'PMART.DIVIDE_BY_ZERO(B.SHOP_EXTEND_RECEIVED_NUM,DECODE(B.MAST_STORE_NUM,0,NULL,B.MAST_STORE_NUM))*100 AS SHOP_EXTEND_RECEIVED_RATE, '+
