REPLACE PROCEDURE PMART.BI_1_3_SUM_FUNC(P_TIME_ID NUMBER,P_LEVEL NUMBER,P_ORG_ID NUMBER,P_PRD_ID NUMBER,P_FILTER_TYPE NUMBER,P_PRD_VALUE NUMBER,P_AVGINPRD NUMBER
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE ('#VT_BI_1_3_SUM_FUNC');          
   IF (P_LEVEL=0) THEN  
      SET ORG_STR  = ' SELECT DISTINCT DEPT_ID,DEPT_NM FROM PMART.LAST_ORG_DIM ';
   ...
   END IF;
   CALL PMART.BI_1_3_FUNC(P_TIME_ID,P_LEVEL,P_ORG_ID,P_PRD_ID,P_FILTER_TYPE,P_PRD_VALUE,P_AVGINPRD,P_C_RATE,P_CP_RATE);
   SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_BI_1_3_SUM_FUNC  AS('+
