REPLACE PROCEDURE PMART.FUNC_FACT_IMPORTANT
(
...
SP:BEGIN
   ...
   SET ORGWHERE = ' WHERE 1=1 ';
	...
	ELSEIF P_PRDTYPE = '1' THEN
		SET V_PRDTYPE = 3;
		SET PRDSELECT = 'SELECT TRIM(TO_CHAR(DIVISION_ID)) AS  DIVISION_ID FROM PDATA.FESTL_DIVISION WHERE ACT_ID = ' +P_ACTID + ' AND CLASS_ID = ' + P_PRDID;
