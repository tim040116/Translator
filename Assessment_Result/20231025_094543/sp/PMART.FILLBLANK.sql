REPLACE PROCEDURE PMART.FILLBLANK (IN P_MONTH_ID NUMBER)
  ...
  DO    
     L1_1:
        BEGIN 
         ...
         INSERT INTO PMART.REMD_FACT  (L_DAY_ID,OSTORE_ID,STORE_ID
         ,BUDGET_ST_AVG_AMT,BUDGET_ST_TOT_AMT,BUDGET_DEPT_AVG_AMT,BUDGET_DEPT_TOT_AMT
         ,STATUS,AC
         ,BUDGET_ST_TOT_PLAN_STNUM,BUDGET_DEPT_TOT_PLAN_STNUM
         ,BUDGET_PDEPT_AVG_AMT,BUDGET_PDEPT_TOT_AMT,BUDGET_PDEPT_TOT_PLAN_STNUM
         )
         SELECT 
          S.L_DAY_ID
         ,S.OSTORE_ID
         ...
         ,S.STATUS
         ,S.AC
         ,S.BUDGET_ST_TOT_PLAN_STNUM
         ,S.BUDGET_DEPT_TOT_PLAN_STNUM
         ,S.BUDGET_PDEPT_AVG_AMT
         ,S.BUDGET_PDEPT_TOT_AMT
         ,S.BUDGET_PDEPT_TOT_PLAN_STNUM
         FROM 
         (
         SELECT 
          A.L_DAY_ID
         ...
         ,B.STATUS
         ,B.AC
         ,B.BUDGET_ST_TOT_PLAN_STNUM
         ,B.BUDGET_DEPT_TOT_PLAN_STNUM
         ,B.BUDGET_PDEPT_AVG_AMT
         ,B.BUDGET_PDEPT_TOT_AMT
         ,B.BUDGET_PDEPT_TOT_PLAN_STNUM                
         ...
         LEFT OUTER JOIN 
              (SELECT L_DAY_ID
                     ...
                     ,0 AS STATUS
                     ,1 AS AC                                          
                     ,BUDGET_ST_TOT_PLAN_STNUM
                     ,BUDGET_DEPT_TOT_PLAN_STNUM
                     ,BUDGET_PDEPT_AVG_AMT
                     ,BUDGET_PDEPT_TOT_AMT
                     ,BUDGET_PDEPT_TOT_PLAN_STNUM
