REPLACE PROCEDURE PMART.NEW_TOX_MMA_MODULE
...
CALL PMART.P_DROP_TABLE ('#VT_NEW_TOX_MMA_MODULE'); 
...
SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOX_MMA_MODULE  AS('+
'SELECT '+
