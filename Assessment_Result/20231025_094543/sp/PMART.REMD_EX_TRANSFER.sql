REPLACE PROCEDURE PMART.REMD_EX_TRANSFER (P_MONTH_ID NUMBER)
...
,C.ACCU_SCUST_NUM  AS EX_ACCU_SCUST_NUM
,D.TOT_SCUST_NUM   AS EX_TOT_SCUST_NUM_LAST_YEAR
FROM
(
SELECT
...
,EX_ACCU_SCUST_NUM          =S.EX_ACCU_SCUST_NUM
,EX_TOT_SCUST_NUM_LAST_YEAR =S.EX_TOT_SCUST_NUM_LAST_YEAR
