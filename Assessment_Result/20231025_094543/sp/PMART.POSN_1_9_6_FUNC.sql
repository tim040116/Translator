REPLACE PROCEDURE PMART.POSN_1_9_6_FUNC
(							 
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE('#VT_POSN_1_9_6_FUNC');
   ...
   SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_POSN_1_9_6_FUNC  AS('+
        'SELECT '+
          'A.MMA_ID AS MMA_ID, '+
          'A.PRD_ID AS PRD_ID, '+
          V_SQL +
          ...
          ' AND A.TIME_ID=C.TIME_ID AND A.ORG_ID=C.ORG_ID AND A.MMA_ID=C.MMA_ID GROUP BY A.MMA_ID,A.PRD_ID'+
