REPLACE PROCEDURE PMART.NEW_TOP_MODULE_21
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TOP_MODULE_21'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOP_MODULE_21  AS('+
                'SELECT '+
                ...
                'PMART.DIVIDE_BY_ZERO(B.INPRD_STORE_NUM,DECODE(B.MAST_STORE_NUM,0,NULL,B.MAST_STORE_NUM))*100 AS INPRD_STORE_RATE,'+
