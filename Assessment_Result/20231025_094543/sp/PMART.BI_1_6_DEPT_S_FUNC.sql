REPLACE PROCEDURE PMART.BI_1_6_DEPT_S_FUNC
(
	P_WEEK_ID NUMBER,
	P_DEPT_ID NUMBER
)
...
SP:BEGIN
	...
	CALL PMART.P_DROP_TABLE ('#VT_BI_1_6_DEPT_S_FUNC');
	CALL PMART.BI_1_6_DEPT_S0_FUNC(P_WEEK_ID);
	SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_BI_1_6_DEPT_S_FUNC  AS( ' 
