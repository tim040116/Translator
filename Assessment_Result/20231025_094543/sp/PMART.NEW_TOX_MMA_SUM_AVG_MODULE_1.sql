REPLACE PROCEDURE PMART.NEW_TOX_MMA_SUM_AVG_MODULE_1
...
FP_PRD_TYPE CHAR,FP_PRD_LEVEL NUMBER,FP_PRD_ID NUMBER,FP_MMA_LIST  VARCHAR(2000))
 SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(64000);     
CALL PMART.P_DROP_TABLE ('#VT_NEW_TOX_MMA_SUM_AVG_MODULE_1'); 
CALL PMART.NEW_TOX_MMA_MFACT_SUM_1(FP_AMT_TYPE,FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_ORG_LEVEL,FP_ORG_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_ID,FP_MMA_LIST);
CALL PMART.NEW_TOX_MMA_STFACT_SUM(FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_ORG_LEVEL,FP_ORG_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_ID,FP_MMA_LIST);
SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOX_MMA_SUM_AVG_MODULE  AS('+   
'SELECT '+
...
'ROUND(A.SALES_AMT/DECODE(B.MAST_STORE_NUM,0,NULL,B.MAST_STORE_NUM),4) AS SALES_EXTEND_AMT, '+
...
'FROM '+
'#VT_NEW_TOX_MMA_MFACT_SUM_1 A '+
'LEFT JOIN #VT_NEW_TOX_MMA_STFACT_SUM B '+
