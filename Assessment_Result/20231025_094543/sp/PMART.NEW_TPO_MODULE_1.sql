REPLACE PROCEDURE PMART.NEW_TPO_MODULE_1
...
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TPO_MODULE_1'); 
   CALL PMART.NEW_TPO_MFACT_1(FP_AMT_TYPE,FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_LIST,FP_ORG_LEVEL,FP_ORG_ID);
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TPO_MODULE_1  AS('+
                'SELECT '+
                ...
                'FROM '+
                '  #VT_NEW_TPO_MFACT_1 A LEFT JOIN  '+
                '  #VT_NEW_TPO_STFACT B  '+
