REPLACE PROCEDURE PMART.NEW_TOP_MMA_MFACT
(FP_AMT_TYPE CHAR,
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TOP_MMA_MFACT'); 
   CASE
      ...
      ELSE
             SET V_TABLE_NAME = 'PMART.BASIC_MFACT_SHOP';
   END CASE;
   SET SQLSTR1 = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOP_MMA_MFACT  AS('+
                'SELECT '+
                   'F1.MMA_ID AS MMA_ID, '+
                   'F1.ORG_ID AS ORG_ID, '+
