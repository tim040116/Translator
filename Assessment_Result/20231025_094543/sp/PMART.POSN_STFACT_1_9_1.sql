REPLACE PROCEDURE PMART.POSN_STFACT_1_9_1
(
FP_TIME_TYPE CHAR,         
...
SP:BEGIN
   ...
   CALL PMART.P_DROP_TABLE ('#VT_POSN_STFACT_1_9_1'); 
   ...
   CASE
      ...
      ELSE 
           SET V_ORG_NAME = '0';
   END CASE;
SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_POSN_STFACT_1_9_1  AS('+
      'SELECT    '+
