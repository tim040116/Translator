REPLACE PROCEDURE PMART.NEW_TPX_MMA_SUM_AVG_MODULE_1
...
SP:BEGIN
   DECLARE SQLSTR  VARCHAR(64000); 	
	...
	CALL PMART.NEW_TPX_MMA_MFACT_SUM_1(FP_AMT_TYPE,FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_LIST,FP_ORG_LEVEL,FP_ORG_ID,FP_MMA_LIST);
	CALL PMART.P_DROP_TABLE ('#VT_NEW_TPX_MMA_STFACT_SUM'); 
	CALL PMART.NEW_TPX_MMA_STFACT_SUM(FP_TIME_TYPE,FP_TIME_LIST,FP_LTIME_LIST,FP_PRD_TYPE,FP_PRD_LEVEL,FP_PRD_LIST,FP_ORG_LEVEL,FP_ORG_ID,FP_MMA_LIST);
    CALL PMART.P_DROP_TABLE ('#VT_NEW_TPX_MMA_SUM_AVG_MODULE_1'); 
    SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TPX_MMA_SUM_AVG_MODULE_1  AS('+    
						'SELECT '+
						...
						'FROM '+
						'#VT_NEW_TPX_MMA_MFACT_SUM_1 A  '+
						'LEFT JOIN #VT_NEW_TPX_MMA_STFACT_SUM B '+
