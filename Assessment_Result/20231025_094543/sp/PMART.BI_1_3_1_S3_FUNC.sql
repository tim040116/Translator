CREATE PROCEDURE PMART.BI_1_3_1_S3_FUNC(P_TIME_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
   DECLARE SQLSTR VARCHAR(1000) DEFAULT '';
      CALL PMART.P_DROP_TABLE ('#VT_BI_1_3_1_S3_FUNC');  
      SET SQLSTR =' CREATE MULTISET VOLATILE TABLE #VT_BI_1_3_1_S3_FUNC  AS('+
