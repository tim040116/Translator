REPLACE PROCEDURE PMART.BI_1_3_ST_FUNC(P_LEVEL NUMBER,P_ORG_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
   DECLARE SQLSTR VARCHAR(1000);
   DECLARE ORG_STR VARCHAR(400);
   CALL PMART.P_DROP_TABLE ('#VT_BI_1_3_ST_FUNC');          
   IF (P_LEVEL=0) THEN  
   ...
   END IF;
   SET SQLSTR ='CREATE MULTISET VOLATILE TABLE #VT_BI_1_3_ST_FUNC  AS('+
