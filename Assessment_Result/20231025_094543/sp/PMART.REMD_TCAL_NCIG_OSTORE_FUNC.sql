REPLACE PROCEDURE PMART.REMD_TCAL_NCIG_OSTORE_FUNC(P_DAY_ID NUMBER,P_RESPON_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(10000) DEFAULT ''; 
  CALL PMART.P_DROP_TABLE ('#VT_REMD_TCAL_NCIG_OSTORE_FUNC'); 
  CALL PMART.REMD_TT_NCIG_OSTORE_FUNC(P_DAY_ID,P_RESPON_ID); 
  SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_REMD_TCAL_NCIG_OSTORE_FUNC  
   (
  ...
  EXECUTE IMMEDIATE SQLSTR; 
      SET SQLSTR = 
            'INSERT INTO #VT_REMD_TCAL_NCIG_OSTORE_FUNC ( TOT_ID,ORG_ID,R1,R2,R3,R4,R5,R6,R7,R8,R9,R10,R11,R12,R13) '+
                'SELECT '+
                'T1.TOT_ID, '+
                'T1.ORG_ID, '+
                ...
                'FROM #VT_REMD_TT_NCIG_OSTORE_FUNC T1 '+
                ';';
    EXECUTE IMMEDIATE SQLSTR; 
END SP;