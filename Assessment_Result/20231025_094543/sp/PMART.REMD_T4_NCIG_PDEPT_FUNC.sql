CREATE PROCEDURE PMART.REMD_T4_NCIG_PDEPT_FUNC(P_DAY_ID NUMBER)
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(4000) DEFAULT ''; 
  CALL PMART.P_DROP_TABLE ('#VT_REMD_T4_NCIG_PDEPT_FUNC'); 
      SET SQLSTR = 
          'CREATE MULTISET VOLATILE TABLE #VT_REMD_T4_NCIG_PDEPT_FUNC AS('+            
				        'SELECT '+
                'B.ORG_ID AS ORG_ID, '+
