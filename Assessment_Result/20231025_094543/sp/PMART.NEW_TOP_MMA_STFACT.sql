REPLACE PROCEDURE PMART.NEW_TOP_MMA_STFACT
...
DECLARE V_TABLE_NAME VARCHAR(60);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TOP_MMA_STFACT'); 
   CASE
    ...
    END CASE;
    SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TOP_MMA_STFACT  AS('+
             'SELECT '+
             'F1.MMA_ID AS MMA_ID, '+
             'Y.ORG_ID AS ORG_ID, '+
