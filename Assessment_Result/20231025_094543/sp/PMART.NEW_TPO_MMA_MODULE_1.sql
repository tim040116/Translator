REPLACE PROCEDURE PMART.NEW_TPO_MMA_MODULE_1
...
FP_ORG_LEVEL NUMBER,FP_ORG_ID NUMBER,FP_MMA_LIST VARCHAR(6000))
SQL SECURITY INVOKER
SP:BEGIN
DECLARE SQLSTR  VARCHAR(64000);
   CALL PMART.P_DROP_TABLE ('#VT_NEW_TPO_MMA_MODULE_1'); 
   ...
   SET SQLSTR = 'CREATE MULTISET VOLATILE TABLE #VT_NEW_TPO_MMA_MODULE_1  AS('+
                    'SELECT '+
                    'A.MMA_ID AS MMA_ID, '+
                    'A.PRD_ID AS PRD_ID, '+
                    'A.TIME_ID AS TIME_ID, '+
                    'B.ORDER_STORE_NUM AS ORDER_EXTEND_STORE_NUM, '+
                    'CAST(B.ORDER_STORE_NUM AS DECIMAL(18,6))/CAST(DECODE(B.MAST_STORE_NUM,0,NULL,B.MAST_STORE_NUM) AS DECIMAL(18,6))*100 AS ORDER_EXTEND_STORE_RATE, '+
                    'B.SALES_STORE_NUM AS SALES_EXTEND_STORE_NUM, '+
                    'CAST(B.SALES_STORE_NUM AS DECIMAL(18,6))/CAST(DECODE(B.MAST_STORE_NUM,0,NULL,B.MAST_STORE_NUM) AS DECIMAL(18,6))*100 AS SALES_EXTEND_STORE_RATE, '+
                    ...
                    'CAST(B.SALES_ORDER_STORE_NUM AS DECIMAL(18,6))/CAST(DECODE(B.MAST_STORE_NUM,0,NULL,B.MAST_STORE_NUM) AS DECIMAL(18,6))*100 AS LEAD_EXTEND_STORE_RATE, '+
                    ...
                    'CAST(B.SHOP_EXTEND_RECEIVED_NUM AS DECIMAL(18,6))/DECODE(B.MAST_STORE_NUM,0,NULL,B.MAST_STORE_NUM)*100 AS SHOP_EXTEND_RECEIVED_RATE, '+
                    ...
                    'A.SALES_DISSUB_EXTEND_AMT AS SALES_DISSUB_EXTEND_AMT, '+
                    'A.SALES_DISSUB_EXTEND_AMT/DECODE(B.SALES_STORE_NUM,0,NULL,B.SALES_STORE_NUM) AS SALES_DISSUB_EXTEND_AMT_AVG, '+
                    'A.SALES_DISSUB_EXTEND_AMT/DECODE(B.MAST_STORE_NUM,0,NULL,B.MAST_STORE_NUM) AS SALES_DISSUB_EXTEND_AMT_MAST_AVG, '+
                    'A.LSALES_DISSUB_EXTEND_AMT AS LSALES_DISSUB_EXTEND_AMT, '+
                    'A.SALES_DISSUB_EXTEND_AMT-A.LSALES_DISSUB_EXTEND_AMT AS LSALES_DISSUB_EXTEND_AMT_DIFF, '+                    
                    'CASE WHEN '+
                    '(A.SALES_DISSUB_EXTEND_AMT/DECODE(A.LSALES_DISSUB_EXTEND_AMT,0,NULL,A.LSALES_DISSUB_EXTEND_AMT)*100)>=10000 THEN 9999.99 '+
                    'WHEN '+
                    '(A.SALES_DISSUB_EXTEND_AMT/DECODE(A.LSALES_DISSUB_EXTEND_AMT,0,NULL,A.LSALES_DISSUB_EXTEND_AMT)*100)<=-10000 THEN -9999.99 '+
                    'ELSE (A.SALES_DISSUB_EXTEND_AMT/DECODE(A.LSALES_DISSUB_EXTEND_AMT,0,NULL,A.LSALES_DISSUB_EXTEND_AMT)*100) END '+
