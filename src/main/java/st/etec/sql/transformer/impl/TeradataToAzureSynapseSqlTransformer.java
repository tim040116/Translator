package st.etec.sql.transformer.impl;
...
import st.etec.sql.transformer.SqlTransformer;
 ...
 * 
 */
public class TeradataToAzureSynapseSqlTransformer extends SqlTransformer{
	...
	public String transformCreateTable(CreateTableModel m) {
		...
		for(TableColumnModel col : m.getColumn()) {
			...
			column+=" "+replaceColumnSetting(col.getSetting());
			column+=",";
		}
