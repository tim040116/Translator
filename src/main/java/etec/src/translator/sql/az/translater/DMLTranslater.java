...
import etec.src.translator.sql.az.translater.service.MergeIntoService;
...
//		res = insert+"\r\n"+DQLTranslater.easyReplace(select);
	 ...
	 * @param	sql
	 * @throws	e
	 * @see		{@link etec.src.translator.sql.gp.translater.DMLTranslater#changeMergeInto(String)}
	 * @return	return_type
			 */
