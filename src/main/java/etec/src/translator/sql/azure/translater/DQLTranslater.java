...
import etec.framework.context.convert_safely.service.SplitCommaSafely;
...
import etec.src.translator.sql.td.model.SelectTableModel;
 ...
 * <br>若需要轉換語法請使用
 * <br>{@link etec.src.translator.sql.azure.translater.SQLTranslater}
 * <br>
 * <br>此類別著重於SQL語句的拆解，
